...
public:
   ...
   void SetLowerXBeamDimensions(PierIDType pierID, Float64 h1l, Float64 h1r, Float64 h2l, Float64 h2r, Float64 x1l, Float64 x1r, Float64 x2l, Float64 x2r, Float64 w, Float64 r, Float64 d, std::vector<CPierPointData> pp) override;
   void GetLowerXBeamDimensions(PierIDType pierID,Float64* ph1,Float64* ph1r,Float64* ph2l,Float64* ph2r,Float64* px1l,Float64* px1r,Float64* px2l,Float64* px2r,Float64* pw,Float64* pr,Float64* d,std::vector<CPierPointData>* pp) const override;
